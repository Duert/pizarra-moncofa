...
MoncofaApp.Animation = {
    ...
    clearFrames() {
        MoncofaApp.UI.showConfirm(
            "Borrar Animación",
            "¿Borrar todos los pasos de la animación?",
            () => {
                this.frames = [];
                this.updateUI();
                this.stop();
                ...
                MoncofaApp.UI.showToast("Animación borrada.", "success");
            }
        );
    },
    ...
    play() {
        if (this.frames.length < 2) {
            MoncofaApp.UI.showToast("Graba al menos 2 pasos para animar.", "warning");
            return;
        }
        this.isPlaying = true;
